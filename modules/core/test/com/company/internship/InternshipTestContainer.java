...
public class InternshipTestContainer extends TestContainer {

    public InternshipTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/internship/app.properties",
    ...
    public static class Common extends InternshipTestContainer {

        public static final InternshipTestContainer.Common INSTANCE = new InternshipTestContainer.Common();
